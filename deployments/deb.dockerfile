...
COPY ./output/$VERSION/usr/local/share/applications/io.github.smcameron.space-nerds-in-space.desktop deb-root/usr/local/share/applications/
COPY ./output/$VERSION/usr/local/share/applications/io.github.smcameron.space-nerds-in-space.svg deb-root/usr/local/share/applications/
